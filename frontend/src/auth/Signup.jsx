...
export default function Signup({ setUser, setLogged, navigateTo }) {
  ...
  return (
    <StyledFormCont>
      ...
      {message !== undefined ? (
        <StyledFormHeading>{message.message}</StyledFormHeading>
      ) : null}
      <StyledForm
      ...
      >
        ...
        <StyledInputContainer>
          <StyledInputForm
            ...
            type={!revealedtwo ? "password" : "text"}
            required
          />
          <StyledImgPassword
            src={!revealedtwo ? eyepasswordclose : eyepassword}
            onClick={() => {
              setRevealedtwo(!revealedtwo);
            }}
          />
